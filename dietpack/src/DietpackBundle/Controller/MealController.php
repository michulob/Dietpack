...
use DietpackBundle\Entity\Meal;
...
class MealController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $meals = $em->getRepository('DietpackBundle:Meal')->findAll();
    ...
    {
        $meal = new Meal();
        $form = $this->createForm('DietpackBundle\Form\MealType', $meal);
    ...
    {
        $deleteForm = $this->createDeleteForm($meal);
        $editForm = $this->createForm('DietpackBundle\Form\MealType', $meal);

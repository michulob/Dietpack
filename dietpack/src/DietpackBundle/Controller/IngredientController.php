...
use DietpackBundle\Entity\Ingredient;
...
class IngredientController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $ingredients = $em->getRepository('DietpackBundle:Ingredient')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('DietpackBundle\Form\IngredientType', $ingredient);
    ...
    {
        $deleteForm = $this->createDeleteForm($ingredient);
        $editForm = $this->createForm('DietpackBundle\Form\IngredientType', $ingredient);
